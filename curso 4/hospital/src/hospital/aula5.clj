...
(let [particular {:id 15 :nome  "Gabriel" :nascimento "28/09/1995" :situacao :urgente}
      plano  {:id 15 :nome  "Gabriel" :nascimento "28/09/1995" :situacao :urgente :plano [:raio-x :ultrassom]}]
...
(let [particular {:id 15 :nome  "Gabriel" :nascimento "28/09/1995" :situacao :normal}
      plano  {:id 15 :nome  "Gabriel" :nascimento "28/09/1995" :situacao :normal :plano [:raio-x :ultrassom]}]
  (pprint (deve-assinar-pre-autorizacao? {:paciente particular :valor 1000 :procedimento :coleta-de-sangue}))
  (pprint (deve-assinar-pre-autorizacao? {:paciente plano :valor 1000 :procedimento :coleta-de-sangue})))